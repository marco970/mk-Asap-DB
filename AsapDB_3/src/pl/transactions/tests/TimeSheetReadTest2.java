...
public class TimeSheetReadTest2 {
	...
	public TimeSheetReadTest2(int idPostepowanie, int mounth, int year) {
...
//		String hql = "from TimeSheetEntity as T "
//				+ "left join Lista as L "
//				+ "where L.status='aktywne' ";
		String hql = "from Lista as L "
				+ "join L.entries as T ";
...
//		System.out.println();
	...
	public static void main(String[] args) {
		new TimeSheetReadTest2(35, 8, 2019);
