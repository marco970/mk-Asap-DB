...
public DBConnect()        {
	...
	for (int i = 0; i < 4; i++) {
		...
		if (processCheck("mysqld_usbwv8.exe")) {
			...
			String jdbcUrl = "jdbc:mysql://localhost:3307/portableu?useSSL=FALSE&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8";
			String user = "root";
