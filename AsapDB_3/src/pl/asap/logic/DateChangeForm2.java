...
public class DateChangeForm2  implements ActionListener, FocusListener  {
	...
	public DateChangeForm2(MainTableModel model, int rowNr) {
		...
		dcForm.setTitle("Zmiana dat postępowania");
		dcForm.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		dcForm.setVisible(true);
		dcForm.setBounds(100, 100, 450, 400);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		dcForm.setContentPane(contentPane);
